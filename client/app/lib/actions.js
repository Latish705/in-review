...
export async function getQuestion (collegeId) {
    try {
        ...
        const response = await axios.get('http://localhost:8080/api/v1/get-all-question-college', collegeId );
...
export async function upvoteQuestion(questionId) {
    try {
        const response = await axios.post('http://localhost:8080/api/v1/upvote-question', questionId);
...
export async function downVoteQuestion (questionId) {
    try {
        const response = await axios.post('http://localhost:8080/api/v1/downvote-question', questionId)
        return (response.data.updatedQuestion);
    } catch (error) {
        throw new Error (error);
    }
